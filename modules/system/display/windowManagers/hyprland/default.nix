...
{
  options.custom.system.display.windowManagers.hyprland.enable = mkEnableOption "Enable hyprland";

  config = mkIf config.custom.system.display.windowManagers.hyprland.enable {
    custom.system.display.wayland.enable = true;

    # Enable waybar and anyrun as well
    custom.programs = {
      anyrun.enable = true;
      waybar.enable = true;
    };
